...
public class ImageUp extends AsyncTask<String, Integer, Object> {
	...
	// post
	public ImageUp(Context ct, ArrayList<String> imagelist, Map<String, String> arrayList, boolean isShowProssDialog,
			VolleyListener listener, String note, String[] str) {
		this.ct = ct;
	...
	protected Object doInBackground(String... params) {
		...
		try {
			...
			result = new String(sb1.toString().getBytes("ISO-8859-1"), "utf-8");
