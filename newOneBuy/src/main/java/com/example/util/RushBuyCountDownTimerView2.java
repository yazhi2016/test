...
public class RushBuyCountDownTimerView2 extends LinearLayout {
	...
	public RushBuyCountDownTimerView2(Context context, AttributeSet attrs) {
		super(context, attrs);

		this.context = context;
		LayoutInflater inflater = (LayoutInflater) context
				.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		View view = inflater.inflate(R.layout.view_countdowntimer2, this);
	...
	public void setTime(int hour, int min, int sec) {
		...
		if (hour >= 60 || min >= 60 || sec >= 100 || hour < 0 || min < 0
				|| sec < 0) {
