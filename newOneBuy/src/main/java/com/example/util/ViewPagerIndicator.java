...
public class ViewPagerIndicator extends View {
	...
	private static float radiusSize = 12;
	//间距
	private static float juli = 8;
	private Paint paint;
...
//		offset = (int) ((percent + position) * 3 * juli);
	...
	private void initPaint() {
		...
		//圆心颜色 #FE6F36
		paint3.setColor(Color.parseColor("#D32725"));
...
//		paint2.setTextSize(26);
	...
	public ViewPagerIndicator(Context context, AttributeSet attrs) {
		...
		//个数
		indicatorCount = array.getInteger(R.styleable.ViewPagerIndicator_indicatorCount, 4);
		array.recycle();// 释放内存
		initPaint();
