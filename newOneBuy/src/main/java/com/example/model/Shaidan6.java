...
public class Shaidan6 {
    ...
    @Expose
    private List<String> sdPhotolist = new ArrayList<String>();
     ...
     *     The sdPhotolist
     */
    public List<String> getSdPhotolist() {
        return sdPhotolist;
    }
     ...
     *     The sd_photolist
     */
    public void setSdPhotolist(List<String> sdPhotolist) {
